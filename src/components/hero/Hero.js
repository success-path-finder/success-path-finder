    ...
    const Brand = () => (
        <div className="flex items-center justify-between py-5 md:block">
            <a href="javascript:void(0)">
                <img
                    src="https://github.com/success-path-finder/success-path-finder/blob/38501d20adbfaadafff0aebbabf2f28d2ad7ad17/src/components/hero/assets/saf.png"
                    width={120}
                    height={50}
                    alt=""
                />
            ...
            <section className="relative">
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                    <div className="space-y-5 max-w-4xl mx-auto text-center">
						...
						Finding Your Potential A Guide To Discovering Your Future Path
                        </h2>
                        <p className="max-w-2xl mx-auto text-gray-400">
                          Embark on a transformative journey of self-discovery and intentional career planning, laying the foundation for unlocking your true potential and finding fulfillment in your professional pursuits.
                        </p>
                        <form
